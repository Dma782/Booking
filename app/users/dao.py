...
class UsersDAO():
    @classmethod
    async def add_user(cls, session: AsyncSession, email: str, hashed_password: str) -> User:
...
class Refresh_token_DAO():
    @classmethod
    async def add_token(cls, session: AsyncSession, user_id: int, jti: str, expire: datetime):
